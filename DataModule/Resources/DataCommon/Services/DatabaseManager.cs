...
public class OdbcDatabaseManager : MyValidatableObject
{
    ...
    */
        ...
        try
        {
            foreach (var pair in this.fasade)
            {
                ...
                foreach (JObject record in tms.dataRecords)
                {
                    try
                    {
                        if(true) System.Console.WriteLine(record);
                        ...
                        foreach (string column in textColumns)
                        {
                            ...
                            {
                                if(true) System.Console.WriteLine(record.ToString());
                    ...
                    {
                        if(true) System.Console.WriteLine(ex);
                        continue;
                    }
    ...
    {
        if(true) System.Console.WriteLine("Инициаллизация источника данных ODBC: ");
        if(true) System.Console.WriteLine("\t строка соединения: "+(this.ds = ds).GetConenctionString());
